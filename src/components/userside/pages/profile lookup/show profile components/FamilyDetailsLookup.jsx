  ...
  return (
    <div className={`${styles.outerwrapper}`}>
      ...
      {isEditing ? (
        ...
        <div className={`container-fluid  ${styles.basic_details}`}>
             <div className="row">
              ...
              <table className={` ${styles.tableBackgroundAlternate}`} >
                    <tbody >
                        <tr   className={styles.rows}>
                            ...
                            <td className={styles.info}>{!details.family_status ? "Not specified" : details.family_status}</td>
                          </tr > 
                          <tr className={styles.rows}>
                            <td className={styles.items}>Father occupation </td>
                            <td className={styles.info}> {!details.father_occupation ? "Not specified" : details.father_occupation}</td>
                        </tr>
                        <tr className={styles.rows}>
                            <td className={styles.items}>Family value :</td>
                            <td className={styles.info}>{!details.family_value ? "Not specified" : details.family_value} </td>
                        </tr>
                        <tr className={styles.rows}>
                            <td className={styles.items}>Mother occupation </td>
                            <td className={styles.info}>{!details.mother_occupation ? "Not specified" : details.mother_occupation}</td>
                        </tr>
                        <tr className={styles.rows}>
                            <td className={styles.items}>Family type </td>
                            <td className={styles.info}>{!details.family_type ? "Not specified" : details.family_type}</td>
                            </tr>
                            <tr className={styles.rows}>
                            <td className={styles.items}>No of brothers </td>
                            <td className={styles.info}>{!details.no_of_brothers ? "Not specified" : details.no_of_brothers}</td>
                        </tr>
                      </tbody>
                      </table>
              </div>
              ...
              <tr className={styles.rows}>
                    ...
                    <td  className={styles.info}> {!details.no_of_brothers_married ? "Not specified" : details.no_of_brothers_married}</td>
                    </tr>
                        <tr className={styles.rows}>
                    <td className={styles.items}>No of sisters :</td>
                    <td  className={styles.info}>{!details.no_of_sisters ? "Not specified" : details.no_of_sisters}</td>
                </tr >
                <tr className={styles.rows}>
                    <td className={styles.items}>No of sisters married :</td>
                    <td  className={styles.info}>{!details.no_of_sisters_married ? "Not specified" : details.no_of_sisters_married}</td>
                  </tr>
                        <tr className={styles.rows}> 
                    <td className={styles.items}>Family location :</td>
                    <td  className={styles.info}>{!details.family_location ? "Not specified" : details.family_location} </td>
                </tr>
                <tr className={styles.rows}>
                    <td className={styles.items}>About my family :</td>
                    <td  className={styles.info1}> {!details.about_family ? "Not specified" : details.about_family}</td>
                </tr>
            </tbody>
            </table>
              </div>
        ...
        <Link className="pt-5" onClick={handleEditButton}><i className="fa fa-edit  text-white pt-5" title='Edit'>edit</i></Link>
        </div>
      )}
    </div>
  )
