    ...
    <div>
      <div className="inputs">
        <Userdropdown
          options={options}
          name="accountFor"
          value={data.accountFor}
          onChange={handleChange}
        />
        {data.accountFor ? (
          <div className="text-info">Account for : {data.accountFor}</div>
        ) : (
          ''
        )}
        <Userinput
        ...
        {!data.name ||
          (!isnameValid && (
            <div className="error">
              Name must contain alphabets and inbetween spaces only
            </div>
          ))}
        <Userinput
          placeholder="email"
        ...
        />
        {!data.email ||
          (!isEmailValid && <div className="error">Invalid email</div>)}
        <Userinput
          placeholder="phone"
          type="number"
          name="phone"
        ...
        />
        {!data.phone ||
          (!isPhoneValid && <div className="error">Invalid phone number</div>)}
        <Userinput
