    ...
    <div>
      <div className="input">
        <div className="d-flex align-items-center">
          <label htmlFor="employed_in" className="mr-3">
            Employed in:
          </label>
          <div className="p-3">
            <Userdropdown
        ...
        {data.employed_in ? (
          <div className="text-info">Profission : {data.employed_in}</div>
        ) : (
          ''
        )}

        <div className="d-flex align-items-center">
          <label htmlFor="annual_income" className="mr-3">
            Annual income :
          </label>
          <div className="p-3">
            <Userdropdown
        ...
        {data.annual_income ? (
          <div className="text-info">Annual income : {data.annual_income}</div>
        ) : (
          ''
        )}
        ...
        {data.state ? (
          <div className="text-info">State : {data.state}</div>
        ) : (
          ''
        )}
        ...
        {isState && (
          <div className="d-flex align-items-center">
            <label htmlFor="district" className="mr-3">
              District :
            </label>
            <div className="p-3">
              <Userdropdown
        ...
        {data.district ? (
          <div className="text-info">District : {data.district}</div>
        ) : (
          ''
        )}
      </div>
