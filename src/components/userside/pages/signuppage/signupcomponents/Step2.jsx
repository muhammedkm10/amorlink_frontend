...
function Step2({
  ...
  const religions = [
    ...
    {
      label: 'Other Indigenous Religions',
      value: 'Other Indigenous Religions',
    },
  ...
  return (
    <div>
      <div className="inputs text-center">
        ...
        {!isDatevalid && (
          <div className="error">Groom should be 18 years old</div>
        )}
        <div className="d-flex ">
          <label htmlFor="" className="p-2">
            Mother toungue :{' '}
        ...
        {data.language ? (
          <div className="text-info">Language : {data.language}</div>
        ) : (
          ''
        )}
        ...
        {data.religion ? (
          <div className="text-info">Religion : {data.religion}</div>
        ) : (
          ''
        )}
