...
const Registration = () => {
  ...
  const handleNextStep = () => {
    if (
      ...
      currentStep === 2 &&
      (!isLanguagevalid || !isReligionvalid || !isCastvalid || !isDatevalid)
    ) {
      notify('Fill the form correctly.....!')
      return
    } else if (
      currentStep === 3 &&
      (!isFamilystatus || !isHeightvalid || !isMaritalstatus || !isGender)
    ) {
      notify('Fill the form correctly.....!')
      return
    } else if (
      currentStep === 4 &&
      (!isAnnualincome || !isDistrict || !isState || !isEmployedin)
    ) {
      notify('Fill the form correctly.....!')
      return
    ...
    switch (currentStep) {
      case 1:
        return (
          <Step1
            ...
            isAccontforValid={isAccontforValid}
      ...
      case 3:
        return (
          <Step3
            data={formData}
            handleChange={handleInputChange3}
            isMaritalstatus={isMaritalstatus}
      ...
      case 4:
        return (
          <Step4
            data={formData}
            handleChange={handleInputChange4}
            isAnnualincome={isAnnualincome}
            isEmployedin={isEmployedin}
            isState={isState}
      ...
      case 5:
        return (
          <Step5
            data={formData}
            handleChange={handleInputChange5}
            isAbout={isAbout}
          />
        )
      default:
                  ...
                  <div className="loginform">
                    ...
                    <div className="loginbutton">
                      <div>
                        ...
                        {currentStep < 5 && (
                          <Userbutton onClick={handleNextStep} name="Next" />
                        )}
                        {currentStep === 5 && (
                          <Userbutton onClick={submitHandler} name="Submit" />
                        )}
                        {loading ? (
