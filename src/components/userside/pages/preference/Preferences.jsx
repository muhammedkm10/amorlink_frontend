    ...
    <div className={styles.body}>
      ...
      <div id="other details" className={styles.otherdetails}>
        <h4 className="text-white ">
          Find your partner based on your preferences
        </h4>
        ...
        <div className={styles.details}>
          <div className={styles.wrapper}>
            ...
            >
              <NavLink
                className={
                  selectedItem === 'personal' ? styles.selected : styles.links
                }
              >
                <CDBSidebarMenuItem
              ...
              <NavLink
                className={
                  selectedItem === 'lifestyle' ? styles.selected : styles.links
                }
              >
                <CDBSidebarMenuItem
              ...
              <NavLink
                className={
                  selectedItem === 'religional' ? styles.selected : styles.links
                }
              >
                <CDBSidebarMenuItem
              ...
              <NavLink
                className={
                  selectedItem === 'profession' ? styles.selected : styles.links
                }
              >
                <CDBSidebarMenuItem
        ...
        <div className={`container  p-1 ${styles.showdetails}`}>
          {selectedItem === 'personal' || selectedItem === null ? (
            <Personal />
          ) : null}
