  ...
  return (
    ...
    <div className={styles.modal_content}>
      ...
      <p className={styles.para_for_subscription}>
            ...
            <li  className={styles.lis}>📨 **Request Unlimited Matches:** Connect with potential partners directly and express your interest without any restrictions.</li>
            <li className={styles.lis}>🔍 **Advanced Search Filters:** Refine your search to find the perfect match based on specific criteria such as interests, values, and goals.</li>
            <li className={styles.lis}>💌 **Priority Messaging:** Ensure your messages are seen first and never miss out on an important connection.</li>
            <li className={styles.lis}>🎁 **Access Premium Features:** Enjoy additional perks like profile highlighting and access to exclusive community events.</li>
            <li className={styles.lis}> **Showing user photos:** Subscribed users can only  see the images of the preferences</li>
            ...
            Don't miss out on the chance to make meaningful connections. Upgrade to a Premium Subscription today and start requesting matches with confidence!
                ...
                <button id={styles.fileinput} className={styles.modal_close} onClick={()=>modalvisiblefunction(false)}>close</button>
