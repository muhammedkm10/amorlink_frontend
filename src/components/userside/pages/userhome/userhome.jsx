    ...
    <div className={styles.fullbody}>
      ...
      <div className={styles.main}>
          ...
          <div className={styles.modal}>
            <div className={styles.modal_content}>
              ...
              <p className={styles.para_for_subscription}>
                {' '}
                At AmorLink, we believe that finding a meaningful and lasting
                relationship should be an enriching and enjoyable experience.
                Our free membership provides access to basic features and
                services, but by upgrading to our Premium Subscription, you
                unlock a suite of exclusive benefits designed to enhance your
        ...
        <div className={`container-fluid ${styles.head}`}>
          <div className="row">
            <div className={`col-lg-5 col-12 ${styles.firstside}`}>
              <div className={styles.para}>
                <p className={styles.lines}>
                  "In the garden of love, we plant seeds of trust and nurture
                  them with patience, for a beautiful journey begins when hearts
                  unite."
                </p>
            ...
            <div className={`col-lg-7 col-12 ${styles.secondside}`}>
              <div className={styles.secondsidephotodiv}></div>
            </div>
          </div>
        </div>
        {/* welcome part */}
        <div className={`container-fluid ${styles.about}`}>
          <div className={styles.welcome}>
            ...
            <p className={styles.welcomecontent}>
              AmorLink is your trusted partner in the journey of love and
              meaningful relationships. We offer a safe, user-friendly platform
              where individuals can find their perfect match based on shared
              values, interests, and life goals. Our goal is to make the process
              of finding love and companionship as seamless and enjoyable as
              possible.
            </p>
          </div>
        </div>
        ...
        <div className={`container-fluid ${styles.complete_profile}`}>
          <h2 className={`${styles.heading2} p-5 text-white text-center`}>
          ...
          <div className={`container-fluid ${styles.editprofilewrapper}`}>
            <div className="row p-5">
              <div className={`col-md-5 col-12  ${styles.give_details}`}>
                <div className="row">
                  ...
                  <div className="col-6  text-center  justify-content-center align-content-center mt-5 ">
                    <p>
                      Upload clear, recent photos to help others get to know you
                      better and increase your chances of finding a meaningful
                      connection
                    </p>
                    <Link to="/profile">
                      <button className={styles.preferencebutton}>
              ...
              <div
                className={`col-md-5 col-12 mt-md-0 mt-3 ${styles.preferences}`}
              >
                <div className="row">
                  <div className="col-6 d-flex justify-content-center align-content-center mt-5">
                  ...
                  <div className="col-6 text-center justify-content-center align-content-center mt-5">
                    <p>
                      Enhance your chances of finding your perfect match by
                      adding all other details to your profile
                    </p>
                    <Link to="/profile">
                      <button className={styles.preferencebutton}>
                        Go to profile
        ...
        <div className={`container-fluid p-0 ${styles.forbodybackground}`}>
                ...
                <div className={`container ${styles.wrapper_feature}`}>
                  <div className={`row ${styles.row_wrapper}`}>
                    <div className={`col-lg-4 col-12 ${styles.feature1}`}>
                      ...
                      <p>
                        {' '}
                        Create a personalized profile to share your story,
                        interests, and preferences with potential matches.
                      </p>
                    </div>
                    <div className={`col-lg-4 col-12 ${styles.feature1}`}>
                      ...
                      <p>
                        {' '}
                        Utilize our advanced matchmaking algorithm to find
                        compatible matches based on your preferences.
                      </p>
                    </div>
                    <div className={`col-lg-4 col-12 ${styles.feature1}`}>
                    ...
                    <div className={`col-lg-4 col-12 ${styles.feature1}`}>
                      ...
                      <p>
                        {' '}
                        Discover potential matches through our easy-to-use
                        search and filter features, allowing to filter results
                        based location, education etc
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Link className={` p-5 text-white text-center `}>
            add your review
          </Link>
