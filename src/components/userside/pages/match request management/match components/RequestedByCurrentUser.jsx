                     ...
                     requestedusers.map((user)=>(
                       <div className={`container ${styles.wrapper}`}> 
                        ...
                        <div className={`col-lg-11 col-6 d-flex  align-items-center  ${styles.image}`}>
                          ...
                          { user.image_details ? (
                              <Link className='text-white ' to={`/shoeprofiles`}  title='click here' state={{ comingfrom: "others_requests" ,userid:user.id}}><img src={`${import.meta.env.VITE_IMAGE}${user.image_details}`}  title='click here' width="50px" className='d-block' height="50px" alt="" /></Link>
                           ):(
                            <Link className='text-white ' to={`/shoeprofiles`}  title='click here' state={{ comingfrom: "others_requests",userid:user.id }}><img src={image} width="50px" height="50px"  title='click here' alt="" /></Link>
                           )
                         }
                      ...
                      <div className={`col-lg-1 col-6 ${styles.details}`}>
                          
                           <div className='mt-2'>
                          

                           <button title="remove" onClick={()=>RemoveFromRequests(user.id)}   className={`fa fa-times mt-2  ${styles.closebutton}`}></button>
...
export default RequestedByCurrentUser