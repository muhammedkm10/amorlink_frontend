          ...
          {!isLoading ? (
            requestedusers && requestedusers.length === 0 ? (
              <p className="text-center text-white">
                Oops.....! No requstes, please make some requests{' '}
              ...
              requestedusers.map((user) => (
                <div className={`container ${styles.wrapper}`}>
                  <div className="row justify-content-evenly text-center">
                    <div
                      className={`col-lg-11 col-6 d-flex  align-items-center  ${styles.image}`}
                    >
                      {user.image_details ? (
                        <Link
                    ...
                    <div className={`col-lg-1 col-6 ${styles.details}`}>
                      <div className="mt-2">
                        <button
                          ...
                          className={`fa fa-times mt-2  ${styles.closebutton}`}
                        ></button>
                      </div>
                    </div>
                  </div>
