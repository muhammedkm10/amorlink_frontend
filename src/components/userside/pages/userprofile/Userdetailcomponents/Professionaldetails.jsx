              ...
              <div className="row">
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <textarea  className={styles.textarea}  name="education_in_details" placeholder={details.education_in_details || "Not specified"} value={editDetails.education_in_details || ''}  onChange={handleChange} />
                    </div>
                  </div>
                  ...
                  <div>
                      ...
                      <input  className={styles.inputfield} type="text"   name="college"  placeholder={details.college || "Not specified"} value={editDetails.college || ''}   onChange={handleChange}/>
                    </div>

                  <div>
                    <label className={styles.label}>Occupation: </label>
                      <select className={styles.dropdown} name="occupation" id="" defaultChecked={details.occupation || "Not specified"} onChange={handleChange} >
                        <option value=""selected>{details.occupation || "None"}</option>
                    ...
                    <div>
                      ...
                      <input  className={styles.inputfield} type="text"   name="organization"  placeholder={details.organization || "Not specified"}  value={editDetails.organization || ''}   onChange={handleChange}/>
                    </div>
                        <div>
        ...
        <div className={`container ${styles.basic_details}`}>
            <div className="row">
                  <div className="col-lg-6 col-12 px-5"> 
                        ...
                        <br />
                        <h4 className={styles.items}>Education  :  <span className={styles.info}>{!details.highest_education ? "Not specified" : details.highest_education}</span></h4>
                        <h4 className={styles.items}>Education in detail: <span className={styles.info}> {!details.education_in_details ? "Not specified" : details.education_in_details}</span></h4></div>
                  <div className="col-lg-6 col-12 px-5">              
                        <h4 className={styles.items}>College : <span className={styles.info}> {!details.college ? "Not specified" : details.college}</span></h4>
                        <h4 className={styles.items}>Occupation : <span className={styles.info}> {!details.occupation ? "Not specified" : details.occupation}</span></h4>
                        <h4 className={styles.items}>Organization : <span className={styles.info}> {!details.organization ? "Not specified" : details.organization}</span></h4>
                  </div>
             </div>
        </div>
