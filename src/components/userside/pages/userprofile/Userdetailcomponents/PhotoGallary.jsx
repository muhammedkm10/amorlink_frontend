...
function PhotoGallary() {
  ...
  const hasImages =
    details.image2 || details.image3 || details.image4 || details.image5
    ...
    <div className={styles.outerwrapper}>
      ...
      {isEditing ? (
        <div className={`container  ${styles.gallary}`}>
          <div className="row">
            <div className="col-md-6 col-12 p-4 ">
              ...
              />
              <label htmlFor="file1" className={styles.customFileLabel}>
                Choose File 1
              </label>
              ...
              <input
                ...
                onChange={handleChange}
              />
              <label htmlFor="file2" className={styles.customFileLabel}>
                Choose File 2
              </label>
            </div>
            <div className="col-md-6 col-12 p-4 ">
              ...
              <input
                ...
                onChange={handleChange}
              />
              <label htmlFor="file3" className={styles.customFileLabel}>
                Choose File 3
              </label>
              ...
              <input
                ...
                onChange={handleChange}
              />
              <label htmlFor="file4" className={styles.customFileLabel}>
                Choose File 4
              </label>
              <div>
        ...
        <div>
                ...
                <div className={`col-md-6 col-12  ${styles.firstpart}`}>
                  <div className={styles.imgwrapper}>
                    <img
                      src={
                        details.image2
                          ? `${import.meta.env.VITE_IMAGE}${details.image2}`
                          : profile
                      }
                      alt="image2"
                    ...
                    {details.image2 && (
                      <button
                        ...
                        title="delete"
                        onClick={() => deleteImage(details.image2, 'image2')}
                      >
                  ...
                  <div className={styles.imgwrapper}>
                    <img
                      src={
                        details.image3
                          ? `${import.meta.env.VITE_IMAGE}${details.image3}`
                          : profile
                      }
                      alt="image3"
                      className={`${styles.images}`}
                    ...
                    {details.image3 && (
                      <button
                        className={styles.deleteButton}
                        title="delete"
                        onClick={() => deleteImage(details.image3, 'image3')}
                      >
                        <FontAwesomeIcon icon={faTrash} />
                      </button>
                    )}
                ...
                <div className={`col-md-6 col-12  ${styles.secondpart}`}>
                  <div className={styles.imgwrapper}>
                    <img
                      src={
                        details.image4
                          ? `${import.meta.env.VITE_IMAGE}${details.image4}`
                          : profile
                      }
                      alt="image4"
                      className={` ${styles.images}`}
                    ...
                    {details.image4 && (
                      <button
                        className={styles.deleteButton}
                        title="delete"
                        onClick={() => deleteImage(details.image4, 'image4')}
                      >
                        <FontAwesomeIcon icon={faTrash} />
                      </button>
                    )}
                  ...
                  <div className={styles.imgwrapper}>
                    <img
                      src={
                        details.image5
                          ? `${import.meta.env.VITE_IMAGE}${details.image5}`
                          : profile
                      }
                      alt="image5"
                      className={` ${styles.images}`}
                    ...
                    {details.image5 && (
                      <button
                        className={styles.deleteButton}
                        title="delete"
                        onClick={() => deleteImage(details.image5, 'image5')}
                      >
                        <FontAwesomeIcon icon={faTrash} />
                      </button>
                    )}
          ...
          <Link to="" className="m-5" onClick={handleEditButton}>
