            ...
            <div className="col-12 px-5">
              <div>
                ...
                <select
                  ...
                  name="religion"
                  id=""
                  defaultChecked={details.religion || 'None'}
              ...
              <div>
                ...
                <select
                  ...
                  name="cast"
                  id=""
                  defaultChecked={details.cast || 'None'}
                  onChange={handleChange}
                >
                  <option value="" selected>
                    {details.cast || 'None'}
              ...
              <div>
                ...
                <input
                  ...
                  type="time"
                  name="time_of_birth"
                  placeholder={details.time_of_birth || 'Not specified'}
                  value={editDetails.time_of_birth || ''}
                  onChange={handleChange}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  type="text"
                  name="place_of_birth"
                  placeholder={details.place_of_birth || 'Not specified'}
                  value={editDetails.place_of_birth || ''}
                  onChange={handleChange}
                />
              </div>
              <div>
