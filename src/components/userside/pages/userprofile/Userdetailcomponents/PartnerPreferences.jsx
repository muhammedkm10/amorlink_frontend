                  ...
                  <table className={` ${styles.tableBackgroundAlternate}`}>
                    <tbody>
                      <tr  className={styles.rows}>
                        ...
                        <td className={styles.info}>{!details.patner_age ? "Not specified" : details.patner_age}</td>
                      </tr>
                      <tr  className={styles.rows}>
                        <td className={styles.items}>Height:</td>
                        <td className={styles.info}>{!details.height ? "Not specified" : details.height}</td>
                      </tr>
                      <tr className={styles.rows}>
                        <td className={styles.items}>Marital status:</td>
                        <td className={styles.info}>{!details.marital_status ? "Not specified" : details.marital_status}</td>
                      </tr>
                      <tr className={styles.rows}>
                  ...
                  <table className={` ${styles.tableBackgroundAlternate}`}>
                    <tbody>
                      <tr className={styles.rows}>
                        ...
                        <td className={styles.info}>{!details.physical_status ? "Not specified" : details.physical_status}</td>
                      </tr>
                      <tr className={styles.rows}>
                        <td className={styles.items}>Drinking habits:</td>
                        <td className={styles.info}>{!details.drinking_habits ? "Not specified" : details.drinking_habits}</td>
                      </tr>
                      <tr className={styles.rows}>
                        <td className={styles.items}>Smoking habits:</td>
                        <td className={styles.info}>{!details.smalking_habits ? "Not specified" : details.smalking_habits}</td>
                      </tr>
                      <tr className={styles.rows}>
