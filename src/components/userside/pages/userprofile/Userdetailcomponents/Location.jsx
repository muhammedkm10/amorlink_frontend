            ...
            <div className="col-lg-6 col-12 px-5">
              <div>
                ...
                <select
                  ...
                  name="state"
                  id=""
                  defaultChecked={details.state || 'Not specified'}
                  onChange={(e) => {
                    handleChange(e), District_function(e.target.value)
                  }}
                >
              ...
              <div>
                ...
                <select
                  ...
                  name="district"
                  id=""
                  defaultChecked={details.district || 'Not specified'}
              ...
              <div>
                ...
                <input
                  ...
                  value={editDetails.ancesters_origin || ''}
                  onChange={handleChange}
                />
              </div>
            </div>
        ...
        <div>
          ...
          <Link to="" className="m-3">
            <i
              ...
              className="fa fa-edit  text-white p-5"
              title="Edit"
            >
              edit
            </i>
