      ...
      <div className={styles.fullbody}>
        <div className={`container-fluid ${styles.head}`}>
          <div className="row p-0">
            <div className={`col-lg-3 col-12  p-0 ${styles.firstside}`}>
              <div className={styles.firstsideDetails}>
                {!usergallarydetails.image1 ? (
                  <img src={image1} alt="image1" className={styles.profile} />
                ) : (
                  <img
                ...
                <div className={styles.about}>
                  ...
                  <Link className={styles.primarydetailseditbutton}>
                    <i
                      onClick={editMaindetails}
                      className="fa fa-edit mt-3 text-info"
                      title="Edit"
                    >
                      edit
                    </i>
            ...
            {isModalShowed && (
              <div className={styles.modal}>
                <div className={styles.modal_content}>
                  ...
                  <label
                    htmlFor="file1"
                    className={`${styles.customFileLabel} ${styles.modal_input}`}
                  >
                    add a full length photo
                  </label>
                  <textarea
                    placeholder={userdetails.about_groom}
                    id={styles.textarea}
                    name="about"
            ...
            <div
              className={`col-lg-9 col-12 ${showSecondSide ? `${styles.secondside} show` : styles.secondside}`}
            >
